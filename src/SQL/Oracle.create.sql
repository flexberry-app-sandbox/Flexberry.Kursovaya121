...
(
	...
	"idДиректора" NVARCHAR2(255) NULL,
...
(
	...
	"ЗаключДоговора" RAW(16) NOT NULL,
...
ALTER TABLE "ОказКонсульт"
	ADD CONSTRAINT "ОказКонсульт__5208" FOREIGN KEY ("ЗаключДоговора") REFERENCES "ЗаключДоговора" ("primaryKey");

CREATE INDEX "ОказКонсульт__1062" on "ОказКонсульт" ("ЗаключДоговора");

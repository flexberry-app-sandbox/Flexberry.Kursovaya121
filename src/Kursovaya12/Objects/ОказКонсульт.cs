...
namespace IIS.Kursovaya12
{
    ...
    public class ОказКонсульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya12.Услуга fПредостУслуга;
        
        private IIS.Kursovaya12.ЗаключДоговора fЗаключДоговора;
        
        private IIS.Kursovaya12.РасчетОстВрем fРасчетОстВрем;
        ...
        public virtual IIS.Kursovaya12.Услуга ПредостУслуга
        {
            get
            {
                ...
                IIS.Kursovaya12.Услуга result = this.fПредостУслуга;
        ...
        [PropertyStorage(new string[] {
                "ЗаключДоговора"})]
        [NotNull()]
        public virtual IIS.Kursovaya12.ЗаключДоговора ЗаключДоговора
        {
            get
            {
                ...
                IIS.Kursovaya12.ЗаключДоговора result = this.fЗаключДоговора;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya12.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Kursovaya12.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Kursovaya12.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказКонсультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказКонсультE", typeof(IIS.Kursovaya12.ОказКонсульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказКонсульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya12.DetailArrayOfОказКонсульт members)

        // *** End programmer edit section *** (IIS.Kursovaya12.DetailArrayOfОказКонсульт members)
        ...
        /// </summary>
        public DetailArrayOfОказКонсульт(IIS.Kursovaya12.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказКонсульт), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Kursovaya12.ОказКонсульт this[int index]
        {
            get
            {
                return ((IIS.Kursovaya12.ОказКонсульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya12.ОказКонсульт dataobject)
        {
